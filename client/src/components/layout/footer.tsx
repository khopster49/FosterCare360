      ...
      <div className="container mx-auto max-w-6xl px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-xl font-bold text-white mb-4">UK Fostering</h2>
            <p className="mb-4">
              We provide safe, supportive homes for children through our network of dedicated foster carers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/apply">
                  <span className="hover:text-white transition-colors cursor-pointer">Apply Now</span>
                </Link>
              </li>
              <li>
                <Link href="/faq">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-sm text-gray-400">
          <p>© {currentYear} UK Fostering. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
